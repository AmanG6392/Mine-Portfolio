...
const About = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative h-screen bg-black/85 overflow-hidden"
    >
      {/* Mountain reflection */}
      <motion.div
      ...
      <div className="container mx-auto px-4 h-full flex flex-col items-center justify-center text-center">
        ...
        <div className="flex flex-col md:flex-row w-full md:h-[22rem] items-center justify-center">
          ...
          <div
            ref={imageRef}
            className="w-full md:w-1/3 flex items-center justify-center  md:justify-start md:pl-[1px]"
          >
            <img
      ...
      <motion.div
        className="pointer-events-none absolute bottom-0 left-0 w-full h-[40vh] z-30"
        style={{
          background:
